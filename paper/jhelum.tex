...
However, the best-fit orbit (pericenter $X~\kpc$, apocenter $X~\kpc$) to the narrow component does not explain the wide component of the Jhelum stream, but does also trace the Indus stream, indicating a possible connection between these two structures.
